// Central Bank of Bahrain exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbb';
...
/** Latest rate for one pair, e.g. getRate('USD', 'BHD', { apiKey }). */
